        ...
        <div class="container-fluid fixed-top p-4">
          <div class="col-12">
            <div v-if="canLogin" class="d-flex justify-content-end">
              <div>
                <Link v-if="$page.props.auth.user" :href="route('dashboard')" class="text-muted text-decoration-none">
                  Dashboard
                </Link>
                ...
                <template v-else>
                  ...
                  <Link v-if="canRegister" :href="route('register')" class="ms-4 text-muted text-decoration-none">
                    Register
                  </Link>
                </template>
              </div>
                  ...
                  <div class="col-md-6 pe-0">
                    <div class="card-body border-right border-bottom p-3 h-100">
                      <div class="d-flex flex-row bd-highlight pt-2">
                        ...
                        <div class="ps-3">
                          <div class="mb-2">
                            <a href="https://laravel.com/docs" class="h5 font-weight-bolder text-dark text-decoration-none">Documentation</a>
                          </div>
                  ...
                  <div class="col-md-6 ps-0">
                    <div class="card-body border-bottom p-3 h-100">
                      <div class="d-flex flex-row bd-highlight pt-2">
                        ...
                        <div class="ps-3">
                          <div class="mb-2">
                            <a href="https://laracasts.com" class="h5 font-weight-bolder text-dark text-decoration-none">Laracasts</a>
                          </div>
                          <p class="text-muted small">
                    ...
                    <div class="card-body border-right p-3 h-100">
                      <div class="d-flex flex-row bd-highlight pt-2">
                        ...
                        <div class="ps-3 text-sm">
                          <div class="mb-2">
                            <a href="https://laravel-news.com/" class="h5 font-weight-bolder text-dark text-decoration-none">Laravel News</a>
                          </div>
                          <p class="text-muted small">
                  ...
                  <div class="col-md-6 ps-0">
                    <div class="card-body p-3 h-100">
                      <div class="d-flex flex-row bd-highlight pt-2">
                        ...
                        <div class="ps-3">
                          <div class="mb-2">
                            <span class="h5 font-weight-bolder text-dark text-decoration-none">Vibrant Ecosystem</span>
                          </div>
                          <p class="text-muted small">
              ...
              <div class="d-flex justify-content-between mt-3">
                <div class="text-sm text-muted">
                  <div class="flex align-content-center">
                    ...
                    <a href="https://laravel.bigcartel.com" class="text-muted text-decoration-none">
                      Shop
                    </a>
                    ...
                    <a href="https://github.com/sponsors/taylorotwell" class="text-muted text-decoration-none">
                      Sponsor
                    </a>
                  </div>
                </div>
